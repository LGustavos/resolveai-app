				...
				<div
					...
					<svg
						style={{
							...
							right: "12%",
							opacity: 0.06,
							animation: "splash-float 8s ease-in-out 1s infinite"
						}}
						width='36'
						height='36'
						viewBox='0 0 24 24'
					...
					<svg
						style={{
							...
							left: "14%",
							opacity: 0.06,
							animation: "splash-float 7s ease-in-out 2s infinite",
					...
					<svg
						style={{
							...
							right: "10%",
							opacity: 0.05,
							animation: "splash-float 6s ease-in-out 3s infinite"
						}}
						width='32'
						height='32'
						viewBox='0 0 24 24'
					...
					<svg
						style={{
							...
							left: "6%",
							opacity: 0.05,
							animation: "splash-float 7s ease-in-out 1.5s infinite"
						}}
						width='30'
						height='30'
						viewBox='0 0 24 24'
					...
					<img
						...
						style={{
							...
							position: "relative",
							animation:
								"splash-logo 0.6s ease-out both, splash-pulse 2s ease-in-out 0.6s infinite"
						}}
					/>
				</div>
				<style
